...
// section start **** CONSTRUCTOR *****
    ...
    public:
    tuiCpltCplx3McuUsartXX_t  (  box_t p_box, margins_t p_margins, pphUsart_t*   p_pPphUSART
                                ,tuiCpltUnit1Button_t*  p_pTuiButton_copy
                                ,tuiCpltUnit1Button_t*  p_pTuiButton_paste
    );
    tuiCpltCplx3McuUsartXX_t       (box_t p_box    ,margins_t p_margin, pphUsart_t*  p_pPphUSART);
