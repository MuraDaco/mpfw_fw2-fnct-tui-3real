...
#ifndef TUI_CPLT_CPLX_4_MCU_USART_WW_H
#define TUI_CPLT_CPLX_4_MCU_USART_WW_H
...
class tuiCpltCplx4McuUsartWW_t :    
    public tuiFnctRealCplx4McuUsartWW_t
...
// section start **** CONSTRUCTOR *****
    ...
    public:
    tuiCpltCplx4McuUsartWW_t       (box_t p_box    ,margins_t p_margin, pphUsartRs485_t*  p_pPphUSART);
...
#endif 	// TUI_CPLT_CPLX_4_MCU_USART_WW_H
