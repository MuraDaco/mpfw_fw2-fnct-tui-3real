...
// section start **** CONSTRUCTOR *****
    ...
    uint8_t tuiCpltCtnr2StreamFormattedString_t::g_initBufferIn1[] = {                                                                   
    ...
    uint8_t tuiCpltCtnr2StreamFormattedString_t::g_initBufferIn2[] = {                                                                   
    ...
    uint8_t tuiCpltCtnr2StreamFormattedString_t::g_initBufferIn3[] = {                                                                   
    ...
    dtyBuffer_t tuiCpltCtnr2StreamFormattedString_t::g_initTextCntnr[] = {                                                               
         {g_initBufferIn1, sizeof(g_initBufferIn1)}                                                                                      
        ,{g_initBufferIn2, sizeof(g_initBufferIn2)}                                                                                      
        ,{g_initBufferIn3, sizeof(g_initBufferIn3)}                                                                                      
        };

    tuiCpltCtnr2StreamFormattedString_t::tuiCpltCtnr2StreamFormattedString_t       (box_t p_box)   :
    ...
    tuiCpltCtnr2StreamFormattedString_t::tuiCpltCtnr2StreamFormattedString_t       (box_t p_box    ,margins_t p_margin)   :
        tuiFnctRealUnit2Cntnr_t     {"Receving data box",   &g_dtyCntnrStreamList}
        ,tuiGrphRealUnit5Base_t     {this, p_box, p_margin}
        ,g_dtyCntnrStreamList       {g_initTextCntnr    ,sizeof(g_initTextCntnr)}
    {}

    tuiCpltCtnr2StreamFormattedString_t::tuiCpltCtnr2StreamFormattedString_t       (box_t p_box    ,margins_t p_margin, dtyBuffer_t* p_initBuffersArray, size_t p_initBuffersArraySize) :
        tuiFnctRealUnit2Cntnr_t     {"Receving data box",   &g_dtyCntnrStreamList}
        ,tuiGrphRealUnit5Base_t     {this, p_box, p_margin}
        ,g_dtyCntnrStreamList       {p_initBuffersArray     ,static_cast<uint16_t>(p_initBuffersArraySize)}
    {}

    tuiCpltCtnr2StreamFormattedString_t::tuiCpltCtnr2StreamFormattedString_t       (uint8_t p_h    ,const char* p_strName    ,tuiCplt_dtyCntnr2StreamListFStr_t* p_dtyCntnrStreamList)   :
        tuiFnctRealUnit2Cntnr_t     {p_strName,   p_dtyCntnrStreamList}
        ,tuiGrphRealUnit5Base_t     {this, p_h}
    {}


    tuiCpltCtnr2StreamFormattedString_t::tuiCpltCtnr2StreamFormattedString_t       (box_t p_box    ,margins_t p_margin  ,tuiCplt_dtyCntnr2StreamListFStr_t* p_dtyCntnrStreamList) :
