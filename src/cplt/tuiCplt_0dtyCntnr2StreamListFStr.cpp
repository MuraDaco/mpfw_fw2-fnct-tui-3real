...
/*
 * tuiCplt_0dtyCntnr2StreamListFStr.cpp
 *
 *  Created on: Nov, 21st 2024 (Thu)
 *      Author: Marco Dau
 */
 
#include "tuiCplt_0dtyCntnr2StreamListFStr.h"


    uint8_t tuiCplt_0dtyCntnr2StreamListFStr_t::g_initBufferIn1[] = {
    ...
    uint8_t tuiCplt_0dtyCntnr2StreamListFStr_t::g_initBufferIn2[] = {
    //  0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,
    ...
    uint8_t tuiCplt_0dtyCntnr2StreamListFStr_t::g_initBufferIn3[] = {
    //  0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,
    ...
    dtyBuffer_t tuiCplt_0dtyCntnr2StreamListFStr_t::g_initUsartTextCntnr[] = {
         {g_initBufferIn1, sizeof(g_initBufferIn1)}
        ,{g_initBufferIn2, sizeof(g_initBufferIn2)}
        ,{g_initBufferIn3, sizeof(g_initBufferIn3)}
        };

tuiCplt_0dtyCntnr2StreamListFStr_t::tuiCplt_0dtyCntnr2StreamListFStr_t   (uint8_t* p_pBuf, uint32_t p_bufSize) :
     dtyCntnr1StreamList_t   (p_pBuf, p_bufSize, g_initUsartTextCntnr, sizeof(g_initUsartTextCntnr), &g_unit, &g_graphic)
    ,g_graphic              (&g_unit, box_t({8, 0, 0,  0}))
{}

tuiCplt_0dtyCntnr2StreamListFStr_t::tuiCplt_0dtyCntnr2StreamListFStr_t   (uint8_t* p_pBuf, uint32_t p_bufSize, dtyBuffer_t* p_pArrayBufIn, uint16_t p_arrayBufInSize) :
     dtyCntnr1StreamList_t   (p_pBuf, p_bufSize, p_pArrayBufIn, p_arrayBufInSize, &g_unit, &g_graphic)
    ,g_graphic              (&g_unit, box_t({8, 0, 0,  0}))
{}
