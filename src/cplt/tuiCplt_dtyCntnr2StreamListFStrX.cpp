...
/*
 * tuiCplt_dtyCntnr2StreamListFStrX.cpp
 *
...
#include "tuiCplt_dtyCntnr2StreamListFStrX.h"
    ...
    uint8_t tuiCplt_dtyCntnr2StreamListFStrX_t::g_initBufferIn1[] = {
    ...
    uint8_t tuiCplt_dtyCntnr2StreamListFStrX_t::g_initBufferIn2[] = {
    //  0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,
    ...
    uint8_t tuiCplt_dtyCntnr2StreamListFStrX_t::g_initBufferIn3[] = {
    //  0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F,0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,
    ...
    dtyBuffer_t tuiCplt_dtyCntnr2StreamListFStrX_t::g_initUsartTextCntnr[] = {
         {g_initBufferIn1, sizeof(g_initBufferIn1)}
        ,{g_initBufferIn2, sizeof(g_initBufferIn2)}
        ,{g_initBufferIn3, sizeof(g_initBufferIn3)}
        };

    uint8_t tuiCplt_dtyCntnr2StreamListFStrX_t::g_pBuf[1000000];

tuiCplt_dtyCntnr2StreamListFStrX_t::tuiCplt_dtyCntnr2StreamListFStrX_t   (void) :
     dtyCntnr1StreamListX_t     (   &g_streamUnit
                                    ,&g_tuiCplt_formattedString
                                    ,&g_tuiCplt_formattedString )
    ,g_streamUnit               (   g_pBuf, sizeof(g_pBuf)
                                    ,g_initUsartTextCntnr, sizeof(g_initUsartTextCntnr) )
{}

tuiCplt_dtyCntnr2StreamListFStrX_t::tuiCplt_dtyCntnr2StreamListFStrX_t   (dtyBuffer_t* p_pArrayBufIn, uint16_t p_arrayBufInSize) :
     dtyCntnr1StreamListX_t     (   &g_streamUnit
                                    ,&g_tuiCplt_formattedString
                                    ,&g_tuiCplt_formattedString )
    ,g_streamUnit               (   g_pBuf, sizeof(g_pBuf)
