...
// section start **** CONSTRUCTOR *****
    ...
    tuiFnctRealUnit3McuUsartX_t::tuiFnctRealUnit3McuUsartX_t      ([[maybe_unused]] pphUsart_t* p_pPphUSART    )   :
...
// section start **** SPECIFIC DATA *****
    ...
    // private:
        void tuiFnctRealUnit3McuUsartX_t::sendMessage    (dtyIntfcAbstractUnitFunctional_t* p_this)     {
            ...
            static_cast<tuiFnctRealUnit3McuUsartX_t*>(p_this)->g_pPphUsart->txBuff_send(
                 reinterpret_cast<uint8_t*>((static_cast<tuiFnctRealUnit3McuUsartX_t*>(p_this)->g_sendingDataBuffer))
                ,20
                );
                        static_cast<tuiFnctRealUnit3McuUsartX_t*>(p_this)->g_recevingDataCntnr.add(
                             reinterpret_cast<uint8_t*>((static_cast<tuiFnctRealUnit3McuUsartX_t*>(p_this)->g_sendingDataBuffer))
                            ,20
                            ,kMarker_t::deviceTx
                            ,kDataType_t::ascii
                        ...
                        static_cast<tuiFnctRealUnit3McuUsartX_t*>(p_this)->g_recevingDataCntnr.selectElementLast();
