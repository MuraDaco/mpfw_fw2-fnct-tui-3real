...
#ifndef TUI_FNCT_REAL_CPLX_3_MCU_USART_H
#define TUI_FNCT_REAL_CPLX_3_MCU_USART_H
...
class tuiFnctRealCplx3McuUsart_t :    public tuiFnctRealUnit2Cntnr_t
{
...
// section start **** CONSTRUCTOR *****
    ...
    public:
    tuiFnctRealCplx3McuUsart_t       (pphUsartRs485_t* p_pPphUSART   );
    //tuiFnctRealCplx3McuUsart_t       (const char* p_strName  ,mcuUsart_t* p_pMcuUSART   );
...
// section start **** SPECIFIC DATA *****
    ...
    private:
        ...
        tuiCplt_0dtyCntnr2StreamListFStr_t   g_recevingDataCntnr;
...
#endif 	// TUI_FNCT_REAL_CPLX_3_MCU_USART_H
