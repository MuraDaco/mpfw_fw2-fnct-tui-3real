...
// section start **** CONSTRUCTOR *****
    ...
    tuiFnctRealCplx3McuUsartX_t::tuiFnctRealCplx3McuUsartX_t    (pphUsartRs485_t*            p_pPphUSART    
...
// section start **** SPECIFIC DATA *****
    ...
    // private:
        ...
        void tuiFnctRealCplx3McuUsartX_t::sendMessage    (dtyIntfcAbstractUnitFunctional_t* p_this)     {
            tuiFnctRealCplx3McuUsartX_t* l_this = static_cast<tuiFnctRealCplx3McuUsartX_t*>(p_this);
